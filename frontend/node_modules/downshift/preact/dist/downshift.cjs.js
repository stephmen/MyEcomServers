...
function useEnhancedReducer(reducer, initialState, props) {
  var enhancedReducer = React__default.useCallback(function (state, action) {
  ...
  var _React$useReducer = React__default.useReducer(enhancedReducer, initialState),
...
var ItemMouseMove = process.env.NODE_ENV !== "production" ? '__item_mouse_move__' : 8;
var ItemClick = process.env.NODE_ENV !== "production" ? '__item_click__' : 9;
var ToggleButtonKeyDownCharacter = process.env.NODE_ENV !== "production" ? '__togglebutton_keydown_character__' : 10;
var ToggleButtonKeyDownArrowDown = process.env.NODE_ENV !== "production" ? '__togglebutton_keydown_arrow_down__' : 11;
var ToggleButtonKeyDownArrowUp = process.env.NODE_ENV !== "production" ? '__togglebutton_keydown_arrow_up__' : 12;
var ToggleButtonClick = process.env.NODE_ENV !== "production" ? '__togglebutton_click__' : 13;
var FunctionToggleMenu = process.env.NODE_ENV !== "production" ? '__function_toggle_menu__' : 14;
var FunctionOpenMenu = process.env.NODE_ENV !== "production" ? '__function_open_menu__' : 15;
var FunctionCloseMenu = process.env.NODE_ENV !== "production" ? '__function_close_menu__' : 16;
var FunctionSetHighlightedIndex = process.env.NODE_ENV !== "production" ? '__function_set_highlighted_index__' : 17;
var FunctionSelectItem = process.env.NODE_ENV !== "production" ? '__function_select_item__' : 18;
var FunctionClearKeysSoFar = process.env.NODE_ENV !== "production" ? '__function_clear_keys_so_far__' : 19;
var FunctionReset = process.env.NODE_ENV !== "production" ? '__function_reset__' : 20;
...
function useSelect(userProps) {
  ...
  var _getElementIds = getElementIds(autoId.useId, props),
  ...
  return {
    ...
    getToggleButtonProps: function getToggleButtonProps(_temp2) {
      ...
      return _extends((_extends3 = {}, _extends3[refKey] = callAll(ref, function (toggleButtonNode) {
    ...
    getMenuProps: function getMenuProps(_temp) {
      ...
      var _ref = _temp === void 0 ? {} : _temp,
          ...
          refKey = _ref$refKey === void 0 ? 'ref' : _ref$refKey,
          ref = _ref.ref,
          rest = _objectWithoutPropertiesLoose(_ref, ["onKeyDown", "onBlur", "refKey", "ref"]);

      return _extends((_extends2 = {}, _extends2[refKey] = callAll(ref, function (menuNode) {
    ...
    getItemProps: function getItemProps(_temp3) {
      ...
      return _extends((_extends4 = {}, _extends4[refKey] = callAll(ref, function (itemNode) {
        if (itemNode) {
